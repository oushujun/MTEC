...
### 5. Remove redundant sequences, `history/maizeTE11212019.ori2` is the combined MTEC library
...
### 2. The file `history/maizeTE11212019.ori3.rexdb.cls.tsv` contains new classifications of the library. Most of them are consistent with the old classification. What really improved are the LTR/unknown classification. Find misclassified entries:
...
### 4. Manually check misclassified sequences. These entries are put in the removal list and removed:
